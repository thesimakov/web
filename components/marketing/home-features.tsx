      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-sm leading-relaxed text-zinc-400 sm:text-base">
            Умная инфраструктура под генерацию: безопасный вывод, превью и контроль версий — в духе продуктов вроде{" "}
            <span className="text-zinc-300">v0</span>, но с вашей схемой и хостингом.
          </p>
        </div>
